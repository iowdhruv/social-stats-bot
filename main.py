...
def get_youtube_data(video_id):
    ...
    try:
        ...
        return {
            ...
            # 'comments': int(stats.get('commentCount', 0)) # No column for this in your sheet!
        }
    except: return None
...
def get_insta_data(media_id):
    ...
    try:
        ...
        # 2. Insights Strategy (Views/Plays)
        final_views = 0
        
        # Try 'views' first (new standard)
        try:
            ...
            if 'data' in r_ins:
                 ...
                 # Retry with 'plays' if views fail
        ...
        if ig_id:
            ...
            if ig_data:
                ...
                if not has_metadata:
                    ...
                    # IG doesn't have length, so we skip Col C
                    has_metadata = True
